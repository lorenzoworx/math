...
# 📖 math <a name="about-project"></a>

** "math" ** is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users to Make simple calculations and read a random math-related quote. 
